...
public class ButtonClickController implements Initializable {
    ...
    @FXML private TableColumn<AirbnbListing, Integer> numberOfReviewsColumn;
    @FXML private TableColumn<AirbnbListing, Integer> numberOfNights;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        numberOfNights.setCellValueFactory(new PropertyValueFactory<>("minimumNights"));
    ...
    public void entryClick() {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/entryClick.fxml"));
        try {
